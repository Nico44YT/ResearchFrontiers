...
public class LegacyWorkbenchBlock extends TwoWideBlock {
    public static final MapCodec<LegacyWorkbenchBlock> CODEC = createCodec(LegacyWorkbenchBlock::new);
    ...
    public LegacyWorkbenchBlock(Settings settings) {
        super(settings);
